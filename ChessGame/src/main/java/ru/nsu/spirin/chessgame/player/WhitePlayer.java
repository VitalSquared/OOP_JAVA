...
import ru.nsu.spirin.chessgame.board.Move.KingSideCastleMove;
import ru.nsu.spirin.chessgame.board.Move.QueenSideCastleMove;
    ...
    protected Collection<Move> calculateKingCastles(final Collection<Move> playerLegals,
        ...
        if (this.playerKing.isFirstMove() && !isInCheck()) {
            ...
            if (!this.board.getTile(59).isTileOccupied() &&
                ...
                if (rookTile.isTileOccupied() && rookTile.getPiece().isFirstMove()) {
                    if (calculateAttacksOnTile(59, opponentLegals).isEmpty() &&
